...
This project is indexed by GitNexus as **coding-tools-mcp** (2472 symbols, 5200 relationships, 208 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

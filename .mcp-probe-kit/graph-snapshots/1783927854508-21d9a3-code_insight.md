...
- id: 1783927854508-21d9a3
- tool: code_insight
- status: ok
- createdAt: 2026-07-13T07:30:54.508Z
- summary: GitNexus 图谱增强已启用（1/1 成功）: context: { "status": "ambiguous", "message": "Found 4 symbols matching 'call_tool'. Use uid, file_path, or kind to d...
...
```json
{
  ...
  "executions": [
    {
      ...
      "ok": true,
      "durationMs": 333,
      "text": "{\n  \"status\": \"ambiguous\",\n  \"message\": \"Found 4 symbols matching 'call_tool'. Use uid, file_path, or kind to disambiguate.\",\n  \"candidates\": [\n    {\n      \"uid\": \"Method:benchmarks/mcp_http.py:McpHttpClient.call_tool#2\",\n      \"name\": \"call_tool\",\n      \"kind\": \"Method\",\n      \"filePath\": \"benchmarks/mcp_http.py\",\n      \"line\": 75,\n      \"score\": 0.54\n    },\n    {\n      \"uid\": \"Method:coding_tools_mcp/server.py:Runtime.call_tool#2\",\n      \"name\": \"call_tool\",\n      \"kind\": \"Method\",\n      \"filePath\": \"coding_tools_mcp/server.py\",\n      \"line\": 1738,\n      \"score\": 0.54\n    },\n    {\n      \"uid\": \"Method:tests/compliance/mcp_client.py:MCPClient.call_tool#2\",\n      \"name\": \"call_tool\",\n      \"kind\": \"Method\",\n      \"filePath\": \"tests/compliance/mcp_client.py\",\n      \"line\": 217,\n      \"score\": 0.54\n    },\n    {\n      \"uid\": \"Method:tests/compliance/mcp_client.py:StdioMCPClient.call_tool#2\",\n      \"name\": \"call_tool\",\n      \"kind\": \"Method\",\n      \"filePath\": \"tests/compliance/mcp_client.py\",\n      \"line\": 382,\n      \"score\": 0.54\n    }\n  ]\n}\n\n---\n**Next:** If planning changes, use impact({target: \"call_tool\", direction: \"upstream\", repo: \"coding-tools-mcp\"}) to check blast radius. To see execution flows, READ gitnexus://repo/coding-tools-mcp/processes."
    }
  ],
  "repo": "coding-tools-mcp",
  ...
  "projectDocs": {
    ...
    "archiveMarkdownFilePath": "E:/workspace/github/coding-tools-mcp-rust/docs/graph-insights/2026-07-13T07-30-54-506Z-context-gitnexus-1-1-context-status-ambiguous-message-fo.md",
    "archiveJsonFilePath": "E:/workspace/github/coding-tools-mcp-rust/docs/graph-insights/2026-07-13T07-30-54-506Z-context-gitnexus-1-1-context-status-ambiguous-message-fo.json",

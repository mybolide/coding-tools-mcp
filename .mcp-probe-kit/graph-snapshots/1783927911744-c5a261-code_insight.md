...
- id: 1783927911744-c5a261
- tool: code_insight
- status: ok
- createdAt: 2026-07-13T07:31:51.744Z
- summary: GitNexus 图谱增强已启用（1/1 成功）: context: { "error": "Symbol 'RuntimeSupervisor' not found" } --- **Next:** If planning changes, use impact({target: ...
...
```json
{
  ...
  "executions": [
    {
      ...
      "ok": true,
      "durationMs": 251,
      "text": "{\n  \"error\": \"Symbol 'RuntimeSupervisor' not found\"\n}\n\n---\n**Next:** If planning changes, use impact({target: \"RuntimeSupervisor\", direction: \"upstream\", repo: \"coding-tools-mcp\"}) to check blast radius. To see execution flows, READ gitnexus://repo/coding-tools-mcp/processes."
    }
  ],
  "repo": "coding-tools-mcp",
  ...
  "projectDocs": {
    ...
    "archiveMarkdownFilePath": "E:/workspace/github/coding-tools-mcp-rust/docs/graph-insights/2026-07-13T07-31-51-744Z-context-gitnexus-1-1-context-error-symbol-runtimesupervi.md",
    "archiveJsonFilePath": "E:/workspace/github/coding-tools-mcp-rust/docs/graph-insights/2026-07-13T07-31-51-744Z-context-gitnexus-1-1-context-error-symbol-runtimesupervi.json",

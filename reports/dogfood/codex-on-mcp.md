...
- Workspace: `/tmp/codex-mcp-dogfood-whmciznc/workspace`
...
- PASS exec_command npm test passes: {"elapsed_ms": 305, "exit_code": 0, "ok": true, "session_id": "oBEDTm6iW4uIQeY-7vb2ouBP", "signal": null, "status": "exited", "stderr": "", "stderr_dropped_bytes": 0, "stderr_om...
...
- PASS exec_command unittest passes: {"elapsed_ms": 64, "exit_code": 0, "ok": true, "session_id": "4IWFa_Ghb-SINeEVAmOcuygg", "signal": null, "status": "exited", "stderr": "..\n-------------------------------------...
...
- PASS exec_command returns session_id: {"elapsed_ms": 45, "exit_code": null, "ok": true, "session_id": "R-c6i-lnYwNKdVY2ERuH8Wfw", "signal": null, "status": "running", "stderr": "", "stderr_dropped_bytes": 0, "stderr...
- PASS write_stdin accepts hello: {"exit_code": null, "ok": true, "session_id": "R-c6i-lnYwNKdVY2ERuH8Wfw", "signal": null, "status": "running", "stderr": "", "stderr_dropped_bytes": 0, "stderr_omitted_bytes": 0...
- PASS write_stdin accepts exit: {"exit_code": 0, "ok": true, "session_id": "R-c6i-lnYwNKdVY2ERuH8Wfw", "signal": null, "status": "exited", "stderr": "", "stderr_dropped_bytes": 0, "stderr_omitted_bytes": 0, "s...
- PASS kill_session terminates or reports already closed: {"exit_code": 0, "killed": false, "ok": true, "session_id": "R-c6i-lnYwNKdVY2ERuH8Wfw", "signal": null, "status": "exited", "stderr": "", "stderr_dropped_bytes": 0, "stderr_omit...
...
- `write_stdin` ok=True args={"chars": "hello\n", "session_id": "R-c6i-lnYwNKdVY2ERuH8Wfw"}
- `write_stdin` ok=True args={"chars": "exit\n", "session_id": "R-c6i-lnYwNKdVY2ERuH8Wfw"}
- `kill_session` ok=True expected_rejection args={"session_id": "R-c6i-lnYwNKdVY2ERuH8Wfw"}
